...
const action_button: = preload("action_button.tscn")

export (Layout) var layout: int = Layout.CENTERED
export (float, 0.0, 300.0) var radius: float = 120 setget set_radius
export (float, 0.0, 1.0) var spacing: float = 0.3 setget set_spacing
export (float, -1.0, 1.0) var offset: float = -0.1 setget set_offset
export (float, 0.01, 0.1) var animation_offset = 0.08
export (float, 0.1, 0.5) var animation_duration = 0.3
